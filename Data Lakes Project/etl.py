...
def process_log_data(spark, input_data, output_data):
    ...
    time_table = df.withColumn("hour",F.month("start_time"))\
    ...
    songplays_table1 = df.join(song_df,df.song == song_df.title, how = 'inner')\
    ...
    songplays_table = songplays_table1.join(time_table, songplays_table1.start_time == time_table.start_time, how="inner")\
                        .select("songplay_id", songplays_table1.start_time, "user_id", "level", "song_id", "artist_id", "session_id", "location", "user_agent", "year", "month")
